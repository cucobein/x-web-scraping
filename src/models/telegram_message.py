...
class TelegramMessageRequest:
    ...
    def to_form_data(self) -> Dict[str, str]:
        ...
        return {"Message": self.message, "Url": self.url}
...
class TelegramMessageResponse:
    ...
    @classmethod
    def from_response(
        cls, status_code: int, response_data: Dict[str, Any]
    ...
    def from_error(
        ...
        Returns:
            TelegramMessageResponse object
        """
        return cls(status_code=status_code, success=False, error=error_message)
